...
export default function ProductComponent({ product, fetchLatestProducts }: Props) {
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <small className="ml-2 text-sm text-gray-600">{new Date(product.created_at).toLocaleDateString()}</small>
                ...
                {editing ? (
                    ...
                    <>
                        ...
                        {product.categories.map((category: Category) => (
                            <p key={category.id} className="text-gray-800">{category.name}</p>
                        ))}
                    </>
                )}
            </div>
